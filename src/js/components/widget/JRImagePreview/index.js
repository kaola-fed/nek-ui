 ...
 * @param {array}      [options.data.imageList]     => 必选，图片文件列表, 其中每个文件项包含下面的字段:
 *                                                     name: 图片文件名称
 *                                                     src: 图片文件的路径
 * @param {number}     [options.data.curIndex=0]    => 必选，当前图片文件的索引, 默认第一项为当前项
 */

const JRImagePreview = Component.extend({
  name: 'jr-image-preview',
